...
public class LinkedListTabulatedFunctionTest {
    ...
    protected MathFunction test = new SqrFunction();
    ...
    LinkedListTabulatedFunction testList = new LinkedListTabulatedFunction(xArr, yArr);
    LinkedListTabulatedFunction testListFun = new LinkedListTabulatedFunction(funArr, funArr);
    LinkedListTabulatedFunction testListEPiZero = new LinkedListTabulatedFunction(ePiZero, ePiZero);
