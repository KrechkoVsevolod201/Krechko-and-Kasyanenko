...
public class LinkedListTabulatedFunctionTest {
    ...
    public void testApply() {
        ...
        final LinkedListTabulatedFunction testFunctionEPiZero = new LinkedListTabulatedFunction(oneEPi, oneEPi);
    ...
    public void testGetX() {
        for (int i = 0; i < 3; i++) {
            ...
            assertEquals(testListEPiZero().getX(i), oneEPi[i], delta);
        }
    }
    ...
    public void testGetY() {
        for (int i = 0; i < 3; i++) {
            ...
            assertEquals(testListEPiZero().getY(i), oneEPi[i], delta);
        }
    }
